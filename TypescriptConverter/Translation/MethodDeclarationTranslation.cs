...
namespace RoslynTypeScript.Translation
{
    public class MethodDeclarationTranslation : BaseMethodDeclarationTranslation, ITypeParameterConstraint
    {
        ...
        protected override string InnerTranslate()
        {
            ...
            {
                return $@"{Syntax.ConvertTriviaToJsDoc()}{Modifiers.Translate()} {Identifier.Translate() + TypeParameterList?.Translate() ?? ""} {ParameterList.Translate()}: {ReturnType.Translate()}
{Body?.Translate() ?? ";"}";
            }
            ...
            return $@"{Syntax.ConvertTriviaToJsDoc()}{GetAttributeList()}{Modifiers.Translate()} {Identifier.Translate()}{TypeParameterList?.Translate() ?? ""} {ParameterList.Translate()} : {ReturnType.Translate()}{appendStr} ";
        }
