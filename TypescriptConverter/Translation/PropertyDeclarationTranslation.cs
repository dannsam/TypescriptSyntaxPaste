    ...
    public class PropertyDeclarationTranslation : BasePropertyDeclarationTranslation
    {
        ...
        protected override string InnerTranslate()
        {
            ...
            if (found is InterfaceDeclarationTranslation)
            {
                ...
                return $"{Syntax.ConvertTriviaToJsDoc()}{Helper.GetAttributeList(Syntax.AttributeLists)}{Syntax.Identifier}: {Type.Translate()} ;";
            }
            ...
            if (AccessorList == null) {
                // inline getter
                return $"{Syntax.ConvertTriviaToJsDoc()}{Modifiers.Translate()} get {Syntax.Identifier}(): {Type.Translate()} {{\n" +
            ...
            if (AccessorList.IsShorten())
            {
                ...
                return $"{Syntax.ConvertTriviaToJsDoc()}{Helper.GetAttributeList(Syntax.AttributeLists)} {Modifiers.Translate()} {Syntax.Identifier}: {Type.Translate()}{defaultStr} ;";
            }

            return $"{Syntax.ConvertTriviaToJsDoc()}{AccessorList.Translate()}";
        }
    }
}
